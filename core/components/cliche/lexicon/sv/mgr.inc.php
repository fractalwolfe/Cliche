...
$_lang['cliche.label_album'] = 'Album';
$_lang['cliche.label_created'] = 'Skapad den {createdon} av {createdby}';
$_lang['cliche.label_albumid'] = 'Album ID';

$_lang['cliche.field_search'] = 'Sök...';
...
$_lang['cliche.album_list_total_pics'] = '<span>{total}</span> bilder';

$_lang['cliche.album_item_cover_image'] = 'Bildomslag för album {name}';
...
$_lang['cliche.album_item_empty_msg'] = '<h4>Det finns inga bilder i detta album</h4><p>Lägg till bilder genom att klicka på knappen "Lägg till bilder"</p>';
$_lang['cliche.album_item_id'] = 'ID';
$_lang['cliche.album_item_information_title'] = 'Information';

$_lang['cliche.btn_add_album'] = 'Lägg till album';
$_lang['cliche.btn_add_photo'] = 'Lägg till bilder';
$_lang['cliche.btn_back_to_album_list'] = 'Tillbaka till albumslista';
...
$_lang['cliche.btn_save_new_order'] = 'Spara ny ordning';
...
$_lang['cliche.window_reorder_album'] = 'Sortera om album';
$_lang['cliche.window_reorder_album_msg'] = 'Är du säker att du vill spara den nya orningen på bilderna i detta album?';
...
$_lang['cliche.no_image'] = '<strong>Fel</strong>Bilden hittades inte';
